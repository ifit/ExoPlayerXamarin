...
//using IDownloadManagerListener = Com.Google.Android.Exoplayer2.Offline.DownloadManager.IListener;
...
//{
//    public class DownloadTracker : Java.Lang.Object, IDownloadManagerListener
//    {
...
//        private Dictionary<string, Download> trackedDownloads;
...
//            File actionFile)
//            //, Download.IState..Deserializer[] deserializers)
//        {
...
//            trackedDownloads = new Dictionary<string, DownloadAction>();
...
//        {
//            return trackedDownloads.ContainsKey(uri.ToString());
//        }

//        public List<StreamKey> GetOfflineStreamKeys(android.Net.Uri uri)
//        {
//            if (!trackedDownloads.ContainsKey(uri.ToString()))
//            {
//                return new List<StreamKey>();
//            }
//            DownloadAction action = trackedDownloads[uri.ToString()];
...
//        public void OnDownloadChanged(Offline.DownloadManager downloadManager, Download download, Java.Lang.Exception finalException)
//        {
//            android.Net.Uri uri = download.Request.Uri;
//            if ((download.IsTerminalState && download.State == Download.StateCompleted)
//                || (!download.IsTerminalState && download.State == Download.StateFailed))
//            {
//                // A download has been removed, or has failed. Stop tracking it.
//                if (trackedDownloads.Remove(uri.ToString()) != false)
//                {
...
//            try
//            {
//                Download[] allActions = actionFile.Load(deserializers);

//                foreach (DownloadAction action in allActions)
//                {
//                    trackedDownloads[action.Uri.ToString()] = action;
//                }
//            }
//            catch (IOException e)
//            {
...
//            DownloadAction[] actions = trackedDownloads.Select(aa => aa.Value).ToList().ToArray();
...
//        {
//            if (trackedDownloads.ContainsKey(action.Uri.ToString()))
//            {
